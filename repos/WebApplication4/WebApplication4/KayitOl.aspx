                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="index.html" class="drop-text">Populer Kurslar</a></li>
                            ...
                            <li><a href="KayitOl.Aspx">Kaydol</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- //nav -->
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" placeholder="Şehir" ></asp:TextBox>
                    </div>
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Kaydol" class="btn btn-danger" OnClick="Button1_Click1"/>
                </form>
            </div>
            <!-- //register -->
        </div>
